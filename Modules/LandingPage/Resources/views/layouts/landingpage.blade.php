...
<head>
    <title>
        {{ \App\Models\Utility::GetValueByName('title_text', APP_THEME()) ? \App\Models\Utility::GetValueByName('title_text', APP_THEME()) : ( env('APP_NAME') ?? 'ElphaBay saas') }}
    </title>
    <!-- Meta -->
    <meta charset="utf-8" />
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        {{-- <p class="mb-0">
                Copyright © 2024 | ElphaBay Technologies
            </p> --}}

            <p class="mb-0">
                @if(isset($setting['footer_text']) && (strpos($setting['footer_text'], "©") === false && strpos($setting['footer_text'], "&copy;") === false))
                    &copy;
                @endif
