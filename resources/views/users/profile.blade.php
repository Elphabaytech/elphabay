                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12">
                                <div class="card">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                {{html()->label('name',__('Name'),array('class'=>'col-form-label')) }}
                                                                {{html()->text('name',null,array('class'=>'form-control font-style','placeholder'=>__('Enter User Name')))}}
                                                                @error('name')
                                                        ...
                                                        <div class="col-md-12">
                                                            {{html()->label('email',__('Email'),array('class'=>'col-form-label')) }}
                                                            {{html()->text('email',null,array('class'=>'form-control','placeholder'=>__('Enter User Email')))}}
                                                            @error('email')
                                    ...
                                    <div class="card-footer">
                                        <div class="col-sm-12 ">
                                            <div class="text-end">
                                                {{ html()->submit(__('Save Changes'), ['class' => 'btn btn-xs btn-primary']) }}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{html()->label('old_password',__('Current Password'),array('class'=>'col-form-label')) }}
                                                    {{html()->password('old_password',array('class'=>'form-control','placeholder'=>__('Enter Current Password')))}}
                                                    @error('old_password')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{html()->label('new_password',__('New Password'),array('class'=>'col-form-label')) }}
                                                    {{html()->password('new_password',array('class'=>'form-control','placeholder'=>__('Enter New Password')))}}
                                                    @error('new_password')
                                            ...
                                            <div class="form-group">
                                                {{html()->label('new_password_confirmation',__('Re-type New Password'),array('class'=>'col-form-label')) }}
                                                {{html()->password('new_password_confirmation',array('class'=>'form-control','placeholder'=>__('Enter Re-type New Password')))}}
                                    ...
                                    {!! html()->hidden('type', Auth::guard()->user()->type) !!}
                                    <div class="card-footer">
                                        <div class="col-sm-12 ">
                                            <div class="text-end">
                                                {{ html()->submit(__('Save Changes'), ['class' => 'btn btn-xs btn-primary']) }}
